...
const performSearch = () => {
    if (searchQuery.value.trim() !== '') {
        router.visit(route('search.results', { query: searchQuery.value }));
    }
};
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <ApplicationMark class="block w-[180px]" />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('properties.index')"
                        ...
                        <div class="flex ml-auto items-center space-x-4">
                            <input type="text" placeholder="Search..."
                                ...
                                @keyup.enter="performSearch" v-model="searchQuery" />
                        </div>
